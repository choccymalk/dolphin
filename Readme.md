...
You could probably build this with emscripten if you replaced cmake and make with emmake. Emscripten provides an example html file for hosting, so you could just use that.
